...
fn deserialize_simd<R: io::Read>(reader: &mut R) -> Result<Instruction, Error> {
    ...
    Ok(Instruction::Simd(match val {
        ...
        I16X8_EXTRACT_LANE_S => I8x16ExtractLaneS(Uint8::deserialize(reader)?.into()),
        I16X8_EXTRACT_LANE_U => I8x16ExtractLaneU(Uint8::deserialize(reader)?.into()),
        I16X8_REPLACE_LANE => I8x16ReplaceLane(Uint8::deserialize(reader)?.into()),
