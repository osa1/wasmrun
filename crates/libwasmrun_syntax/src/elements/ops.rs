    ...
    fn serialize<W: io::Write>(self, writer: &mut W) -> Result<(), Self::Error> {
        ...
        match self {
            ...
            I32TruncSatSF32 => {
                ...
                VarUint32::from(u32::from(I32_TRUNC_SAT_F32_S)).serialize(writer)?;
            }
            I32TruncSatUF32 => {
                op!(writer, TRUNC_SAT_PREFIX);
                VarUint32::from(u32::from(I32_TRUNC_SAT_F32_U)).serialize(writer)?;
            }
            I32TruncSatSF64 => {
                op!(writer, TRUNC_SAT_PREFIX);
                VarUint32::from(u32::from(I32_TRUNC_SAT_F64_S)).serialize(writer)?;
            }
            I32TruncSatUF64 => {
                op!(writer, TRUNC_SAT_PREFIX);
                VarUint32::from(u32::from(I32_TRUNC_SAT_F64_U)).serialize(writer)?;
            }
            I64TruncSatSF32 => {
                op!(writer, TRUNC_SAT_PREFIX);
                VarUint32::from(u32::from(I64_TRUNC_SAT_F32_S)).serialize(writer)?;
            }
            I64TruncSatUF32 => {
                op!(writer, TRUNC_SAT_PREFIX);
                VarUint32::from(u32::from(I64_TRUNC_SAT_F32_U)).serialize(writer)?;
            }
            I64TruncSatSF64 => {
                op!(writer, TRUNC_SAT_PREFIX);
                VarUint32::from(u32::from(I64_TRUNC_SAT_F64_S)).serialize(writer)?;
            }
            I64TruncSatUF64 => {
                op!(writer, TRUNC_SAT_PREFIX);
                VarUint32::from(u32::from(I64_TRUNC_SAT_F64_U)).serialize(writer)?;
            }
